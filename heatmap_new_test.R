...
library(colorspace)
pal <-choose_palette()
data <- read.table("/home/p/pavlovma/Java2/Java/Eclipse/Gobi/output/assignmentBlock/Correlations/Not_pooled/correlation_pooled_mutually_exclusive_exons_full_quant.txt"
                   , sep="\t", header=TRUE)
